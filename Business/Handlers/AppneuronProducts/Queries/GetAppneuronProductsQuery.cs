...
namespace Business.Handlers.AppneuronProducts.Queries
{
    ...
    {
        public class GetAppneuronProductsQueryHandler : IRequestHandler<GetAppneuronProductsQuery, IDataResult<IEnumerable<AppneuronProduct>>>
        {
            private readonly IAppneuronProductRepository _appneuronProductRepository;
            private readonly IMediator _mediator;

            public GetAppneuronProductsQueryHandler(IAppneuronProductRepository appneuronProductRepository, IMediator mediator)
            {
